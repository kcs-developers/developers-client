...
interface SelectDropdownProps {
  ...
  const SelectDropdown: React.FC<SelectDropdownProps> = ({ selectName, options, paramName }) => {
    ...
    const [selectDropValue, setSelectDropValue] = useState('Stack을 선택하세요')
    const toggleSelect = () => {
        setIsOpen(!isOpen);
    }
    ...
    const handleClear = () => {
        setSelectDropValue("Stack을 선택하세요");
    };
                        ...
                        <div className="w-full  svelte-1l8159u">
                            <div className="my-2 bg-white p-1 flex border border-gray-200 rounded svelte-1l8159u">
                                ...
                                <input
                                    ...
                                    style={{ color: selectDropValue === "Stack을 선택하세요" ? "gray" : "black", fontSize: selectDropValue === "Stack을 선택하세요" ? "9pt" : "inherit" }}
                                    readOnly
                                />                             
                                <div>
                                    <button
